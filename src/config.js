const config = {
	...
	metaData: {
		title: 'Starry的个人主页🎉',
		description: '欢迎来到Starry的奇妙世界！',
		keywords: 'Starry,Starry,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/avatar.jpg", // 头像
	welcometitle: "Hi, I'm Starry", // 标题
	...
	projectcards: [
		{ go: "🚀 前往", img: "/img/sunshine.jpg", title: "个人博客", subtitle: "1,000 miles of wonder", text: "博客", url: "https://blog.wlove.top", show: false },
		{ go: "🗂️ 前往", img: "/img/sunshine.jpg", title: "梦境分享", subtitle: "2,000 miles of wonder", text: "梦境分享", url: "http://yume.ly/", show: false },
		{ go: "📝 前往", img: "/img/sunshine.jpg", title: "高清世界名画", subtitle: "3,000 miles of wonder", text: "高清世界名画", url: "https://www.nbfox.com/", show: false },
		{ go: "👍 前往", img: "/img/sunshine.jpg", title: "城市大像素", subtitle: "4,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://bigpixel.cn/zh-CN.html", show: false },
		{ go: "🗃 前往", img: "/img/sunshine.jpg", title: "平面设计", subtitle: "5,000 miles of wonder", text: "平面设计", url: "https://www.chuangkit.com/", show: false },
	...
	statement: ["备案号：渝ICP备2024021941号", "Copyright © 2025 Starry"],
}
